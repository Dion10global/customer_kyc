...
INSERT INTO customers (name, email, created_at) VALUES
  ('Thandiwe Mokoena',  'thandi.mokoena@example.co.za', '2026-01-12 09:14:00'),
  ('Sipho Dlamini',   'sipho.dlamini@example.co.za',  '2026-02-03 11:42:00'),
  ('Lerato Khumalo',  'lerato.k@example.co.za',       '2026-02-21 16:05:00'),
  ('John van Wyk',   'john.vw@example.co.za',       '2026-03-08 08:30:00'),
  ('Alisha Patel',     'alisha.patel@example.co.za',    '2026-04-15 14:00:00')
